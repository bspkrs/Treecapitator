...
public class TCConst
{
    ...
    public static final String GLOBALS_SETTINGS_CTGY              = TCConst.SETTINGS_CTGY + "." + GLOBAL_SETTINGS;
    public static final String PER_TREE_DEFAULTS_CTGY             = TCConst.SETTINGS_CTGY + "." + PER_TREE_DEFAULTS;
    ...
    public static final String COREMOD_WARNING                    = "TreeCapitator hook has not been injected. Possible causes: 1. You deleted META-INF from the mod archive. Don't do this. 2. You are trying to run from Eclipse and forgot to put the dummy jar in the mcp/jars/mods folder.";
